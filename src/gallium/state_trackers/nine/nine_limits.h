...
// if outside a range, state value is unchanged
#define NINE_STATE_RANGE_PREV_VAL    4
// if outside a range, state value is changed to a default value
#define NINE_STATE_RANGE_DEF_VAL    5
...
#define __RANGE_PREV_VAL_RS(o, m, M) \
    [D3DRS_##o] = {NINE_STATE_RANGE_PREV_VAL, {.clamp = {m, M}}}
...
render_state_limits_table[D3DRS_BLENDOPALPHA + 1] = {
    ...
    __TO_DETERMINE_RS(SHADEMODE, 1, 3),
    ...
    __TO_DETERMINE_RS(CULLMODE, 1, 3),
    ...
    __TO_DETERMINE_RS(SRCBLENDALPHA, 1, 17),
    __TO_DETERMINE_RS(DESTBLENDALPHA, 1, 17),
    __TO_DETERMINE_RS(BLENDOPALPHA, 1, 5)
};
...
nine_fix_render_state_value(D3DRENDERSTATETYPE State,
                            DWORD Value)
{
    struct nine_state_behaviour behaviour;
    ...
    case NINE_STATE_MASK:
        ...
        break;
    case NINE_STATE_RANGE_PREV_VAL:
        assert(!"TODO");
        break;
